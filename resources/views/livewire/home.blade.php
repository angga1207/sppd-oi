<div class="min-h-screen">
    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('login') }}"
                        class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-navy hover:bg-opacity-90 transition duration-150">
                        Masuk
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <div class="mt-10 flex justify-center gap-4">
                    <a href="{{ route('login') }}"
                        class="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-navy bg-white hover:bg-gray-50 transition duration-150 shadow-lg">
                        Mulai Sekarang
    ...
    <section class="py-20 bg-white hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div
                    class="bg-cream rounded-2xl p-8 shadow-lg hover:shadow-xl transition duration-300 border-t-4 border-navy">
                    ...
                    <p class="text-gray-600">Buat surat perintah perjalanan dinas secara digital dengan formulir yang
                        mudah dan terstruktur.</p>
                </div>

                <!-- Feature 2 -->
                <div
                    class="bg-cream rounded-2xl p-8 shadow-lg hover:shadow-xl transition duration-300 border-t-4 border-blue-light">
                    ...
                    <p class="text-gray-600">Sistem persetujuan bertingkat yang efisien untuk mempercepat proses
                        approval SPPD.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600">Dapatkan insight lengkap dengan dashboard interaktif dan laporan yang
                        detail.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600">Data Anda terlindungi dengan sistem keamanan yang terpercaya dan enkripsi.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-600">Akses dari perangkat apapun - desktop, tablet, atau smartphone dengan
                        tampilan optimal.</p>
                </div>
            </div>
        </div>
    ...
    <!-- CTA Section -->
    <section class="bg-gradient-to-r from-navy to-blue-light py-16 hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('login') }}"
                class="inline-flex items-center px-8 py-3 border-2 border-white text-base font-medium rounded-lg text-white hover:bg-white hover:text-navy transition duration-150">
                Login Sekarang
            </a>
        </div>
    </section>
