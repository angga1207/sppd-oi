    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-muted">
                    Kelola Surat Perintah Perjalanan Dinas (SPPD) untuk nomor surat {{ $dataSuratPerintah->nomor_surat
                    }}
                </p>
            </div>
            <a href="{{ route('admin.surat-perintah.edit', ['id' => $dataId]) }}" class="btn-secondary">
        ...
        <div class="hidden card mb-8">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h4 class="text-sm font-semibold text-muted">Nomor Surat</h4>
                        <p class="mt-1 text-lg font-medium text-gray-900">
                            {{ $dataSuratPerintah->nomor_surat }}
                        </p>
                    </div>
                    <div>
                        <h4 class="text-sm font-semibold text-muted">Perangkat Daerah</h4>
                        <p class="mt-1 text-lg font-medium text-gray-900">
                            {{ $dataSuratPerintah->instance->name ?? '' }}
                        </p>
                    </div>
                    <div>
                        <h4 class="text-sm font-semibold text-muted">Dasar</h4>
                        <p class="mt-1 text-lg font-medium text-gray-900">
                            {!! $dataSuratPerintah->dasar !!}
                        </p>
                    </div>
                    <div>
                        <h4 class="text-sm font-semibold text-muted">Tujuan</h4>
                        <p class="mt-1 text-lg font-medium text-gray-900">
                            {!! $dataSuratPerintah->tujuan !!}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-8">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2">
                            ...
                            <button type="button" wire:click="fetchSemestaUsers" wire:loading.attr="disabled"
                                ...
                                <span wire:loading.remove wire:target="fetchSemestaUsers" class="flex items-center">
                    ...
                    <div class="col-span-1 md:col-span-2 mb-4 p-4 bg-blue-light bg-opacity-20 rounded-lg">
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    @if($selectedEmployee)
                    <div class="col-span-1 md:col-span-2 mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <div class="">
                        ...
                        <div class="flex items-center gap-2 mt-4">
                            ...
                            <button type="button" wire:click="confirmAddEmployee" class="px-4 py-2 btn-primary">
        ...
        <div class="card mt-8 p-4">
            <div class="flex items-center justify-between">
                ...
                <div>
                    <a href="{{ route('admin.surat-perintah.index') }}" class="px-4 py-2 btn-primary whitespace-nowrap">
