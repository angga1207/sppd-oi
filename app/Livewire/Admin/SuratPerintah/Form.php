...
class Form extends Component
{
    ...
    private function loadSuratPerintah($id)
    {
    ...
    public function updated($field)
    {
        ...
        if ($field == 'dataSuratPerintah.klasifikasi_surat_id') {
            ...
            $prefixNomorSurat = collect($this->klasifikasiOptions)
                ->firstWhere('id', $this->dataSuratPerintah['klasifikasi_surat_id'])['kode'] ?? '';
    ...
    public function submitForm($type = null)
    {
        ...
        $this->validate([
            ...
            'dataSuratPerintah.tujuan' => 'Tujuan Perjalanan',
